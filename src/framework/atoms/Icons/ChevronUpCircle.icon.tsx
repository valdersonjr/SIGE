...
export const ChevronUpCircle = ({ color, ...props }: SVGProps<SVGSVGElement>) => (
    <svg width="30" height="31" viewBox="-3 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M11.47 13.26L15 9.73999L18.53 13.26" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <defs>
        <filter id="filter0_d_10112_2916" x="0.25" y="1.25" width="29.5" height="29.5" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
