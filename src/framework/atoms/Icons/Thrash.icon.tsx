...
export const ThrashIcon = ({ color, ...props }: SVGProps<SVGSVGElement>) => (
    <svg width="33" height="32" viewBox="-3 -3 33 32" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} >
        <path d="M21 5.98001C17.67 5.65001 14.32 5.48001 10.98 5.48001C9 5.48001 7.02 5.58001 5.04 5.78001L3 5.98001" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
