...
export const SearchSelect: React.FC<SelectSearchProps> = (props) => {
    ...
    return (
        <S.Container>
            ...
            {/*<S.SelectSearch options={props.options} search={props.search} placeholder={props.placeholder}*/}
            {/*                className={{background: 'none'}} getOptions={props.getOptions}*/}
            {/*/>*/}
            <Select styles={{control: (baseStyles) => ({
                    ...baseStyles,
                    height: "6vh",
                    width: "100%",
                    fontSize: "14px",
